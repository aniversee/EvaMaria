...
API_ID = int(environ.get('API_ID', '24936491'))

API_HASH = environ.get('API_HASH', 'fa29ce9a927b6c833b2026afe917fa3a')

BOT_TOKEN = environ.get('BOT_TOKEN', '5772302852:AAHhsRXPq0RwNuVJOJiyjrUCg-W-SymEwsg')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5426363083').split()]

CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001697442319').split()]
...
AUTH_CHANNEL = -1001503957742

AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information

DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://animeverse:animeverse@cluster0.1lpixc1.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001841775659'))
